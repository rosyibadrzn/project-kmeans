      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Proses Perhitungan</h3></div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Hitung Data</li>
                </ol>
              </div>
            </div>
            <!--end::Row-->
              ...
              <div class="table-wrapper">
                ...
                <div class="row g-4 mb-4">
                      <div class="container mt-5">
                        <h1 class="text-center">Berikan Input Cluster</h1>
                        <!-- Form Input Jumlah Klaster -->
                        <form method="POST" action="info-box.php" class="text-center">
                          <div class="mb-3">
                              <label for="k" class="form-label">Jumlah Cluster (k):</label>
                              <input type="number" id="k" name="k" class="form-control w-25 mx-auto" required>
                          </div>
                          <div class="container mt-5 text-center">
                                  <button type="submit" name="clear_data" class="btn btn-success btn-lg">
                                    <i class="bi bi-calendar-check"></i> Cluster Data
                                  </button>
                                </div>
                        </form>
                      </div>
